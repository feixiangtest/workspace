<template>
    <div class="mainBox">
        <div class="list-part-out">
            <div class="list-part">
                <div class="list-title"><i class="yo-icon"></i>基本信息</div> 
                <dl class="public-list clearfix">
                    ...
                    <dd class="common-item">
                        ...
                        <p class="con-txt">
                            <input type="password" placeholder="6-12位字母和数字的组合" value="cici222">
                        </p>
                    </dd>
                    <dd class="common-item">
                        <h5 class="title">昵称</h5>
                        <p class="con-txt">
                            <input type="text" placeholder="请输入1-20个字符" value="cici222">
                        </p>
                    </dd>
                    <dd class="common-item">
                        <h5 class="title">账号状态</h5>
                        <p class="con-txt">
                            <label class="mint-switch"><input type="checkbox" class="mint-switch-input"> <span class="mint-switch-core"></span> <div class="mint-switch-label"></div></label>
                        </p>
                    </dd>
                    <dd class="common-item">
                    ...
                    <dd class="common-item">
                        ...
                        <p class="con-txt">
                            <input type="text" value="PwI96U">
                        </p>
                    </dd>
                    <dd class="common-item">
                        <h5 class="title">余额</h5>
                        <p class="con-txt">1253.69</p>
                    </dd>
                    <dd class="common-item">
                        <h5 class="title">返水金额</h5>
                        <p class="con-txt">896.23</p>
                    </dd>
                    <dd class="common-item">
            ...
            <div class="list-part">
                ...
                <dl class="public-list clearfix">
                    <dd class="common-item">
                        <h5 class="title">AG视讯</h5>
                        <p class="con-txt">
                            <input class="small input-type1" type="number" placeholder="最低返点" value="0.1"><span>% —</span><input class="small" type="number" placeholder="最高返点" value="1.2"><span>%</span>
                        </p>
                    </dd>
                    <dd class="common-item">
                        <h5 class="title">OG视讯</h5>
                        <p class="con-txt">
                            <input class="small input-type1" type="number" placeholder="最低返点" value="0.2"><span>% —</span><input class="small" type="number" placeholder="最高返点" value="1.5"><span>%</span>
                        </p>
                    </dd>
                    <dd class="common-item">
                        <h5 class="title">BB视讯</h5>
                        <p class="con-txt">
                            <input class="small input-type1" type="number" placeholder="最低返点"  value="0.1"><span>% —</span><input class="small" type="number" placeholder="最高返点" value="1.6"><span>%</span>
                        </p>
                    </dd>
                    <dd class="common-item">
                        <h5 class="title">AB视讯</h5>
                        <p class="con-txt">
                            <input class="small input-type1" type="number" placeholder="最低返点" value="0.2"><span>% —</span><input class="small" type="number" placeholder="最高返点" value="0.8"><span>%</span>
                        </p>
                    </dd>
                </dl>
            </div>
            <div class="btn-box btn-block text-center">
                <a href="javascript:void(0)" class="btn btn-lg btn-primary">保存</a>
            </div>
        </div>
    </div>
</template>
